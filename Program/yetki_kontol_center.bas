Attribute VB_Name = "yetki_kontol_center"
'Kullanýcý Yetki Kontrol ver.1.0.12.14
'Function kontol_bir()
...
'End Function
'Function kontrol_uc()
'Bu Bölümde Kullanýcý Sadece Mesaj alýr gonderebilir.
'If Baglan.Label16.Caption = "0" Then
'Kullanýcýnýn Bu Özelliði Yok ise
'Form1.Toolbar1.Buttons(12).Visible = True 'Kullanýcý Ekle Bölümünü Görmesin.
'Form1.Toolbar1.Buttons(13).Visible = True 'Kullanýcý Ekle Bölümünü Cizgisi Görmesin.
'Else
