Attribute VB_Name = "giden_mesaj"
Function giden_mesajlar()
...
Dim giris
giris = Baglan.Text1.Text ' Kullanýcý Kim?
'Sorgu Ekraný
'Okunmamýþ Olcak
'Silinmemiþ Olcak
'Gonderilen Olmayacak
'Gonderilmemiþ Olmayacak
'rs.Open "Select * From mesajlar Where kimden ='" & giris & "' and silindi='0' and gonderilen = '1' ", conn, adOpenKeyset, adLockOptimistic
rs.Open "Select * From mesajlar Where kimden ='" & giris & "' and silindi='0' and gonderilen='1' ", conn, adOpenKeyset, adLockOptimistic
Do Until rs.EOF
Dim itm As ListItem
...
itm.SubItems(5) = rs!kime & " " '& rs!txtbilgi
